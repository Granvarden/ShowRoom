...
public class managecustomer extends javax.swing.JInternalFrame {
    ...
    public void forTable(){
        ...
        try{
            ...
            String[] colname = {"id", "name", "surname", "phone", "email", "budget", "em_id", "car_book", "date", "username", "password", "plan"};
            int i = 0;
            ...
            while (rs.next()){
                ...
                String[] row = {id, name, surname, phone, email, budget, em_id, car_book, date, username, password, plan};
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        customerisnullLaabel = new javax.swing.JLabel();
        ...
        customerisnullLaabel.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(customerisnullLaabel)
    ...
    private void jButtonConfirmDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmDelActionPerformed
        String customerIDText = jTextFieldCustomerID.getText();
        if (!customerIDText.isEmpty()) {
            try {
                int customerID = Integer.parseInt(customerIDText);
                Admin x = new Admin();
                x.calcelCus(String.valueOf(customerID));
                p.removeAll();
                managecustomer cu = new managecustomer(p);
                p.add(cu).setVisible(true);
            } catch (NumberFormatException e) {
                customerisnullLaabel.setText("Please enter a valid Customer ID.");
            }
        } else {
            customerisnullLaabel.setText("Please Enter Customer ID.");
        }
    }//GEN-LAST:event_jButtonConfirmDelActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel customerisnullLaabel;
